    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('mate', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='greenmates.mate')),
                ('me', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='you', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='UserRequest',
        ...
        migrations.AddField(
            model_name='mate',
            name='moim',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='greenmates.moim'),
        ),
        migrations.AddField(
            model_name='mate',
            name='user',
